import 'package:asm/controller/sub_controller.dart';
import 'package:asm/view/multiply_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class SubScreen extends StatelessWidget {
  SubScreen({super.key});
  final c = Get.put(SubController());
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Text("The subtract is:", style: TextStyle(fontSize: 20)),
